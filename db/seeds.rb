...
Yard.create!(title: "West", location: "Golden Gate Park", lng: -122.487989, lat: 37.769556, user_id: 2)
Yard.create!(title: "South", location: "Delores Park", lng: -122.427406, lat: 37.760383, user_id: 5)
Yard.create!(title: "North", location: "Hyde st. Pier", lng: -122.421307, lat: 37.809131, user_id: 4)
Yard.create!(title: "East", location: "App Academy", lng: -122.394049, lat: 37.791118, user_id: 1)
Yard.create!(title: "Central", location: "Filmore Auditorium", lng: -122.433150, lat: 37.784145, user_id: 1)
Yard.create!(title: "Not Pictured", location: "Other Side of the world", lng: 122.433150, lat: 37.784145, user_id: 1)
Yard.create!(title: "Downtown", location: "Downtown", lng: -122.468147, lat: 37.746101, user_id: 1)
Yard.create!(title: "Delete me", location: "Delete Me", lng: -122.458167, lat: 37.746101, user_id: 2)
Yard.create!(title: "Delete me also", location: "delete me also!", lng: -122.478157, lat: 37.746101, user_id: 1)
Yard.create!(title: "Ho Chi Minh", location: "Hideout Hostel", lng: 106.691892, lat: 10.768099, user_id: 6)
Yard.create!(title: "Phong Nha", location: "Easy Tiger Hostel", lng: 106.310667, lat: 17.610048, user_id: 6)
Yard.create!(title: "Tempelhof", location: "Berlin Park", lng: 13.391921, lat: 52.472142, user_id: 6)
